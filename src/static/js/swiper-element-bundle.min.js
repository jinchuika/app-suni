...
!(function () {
    ...
    var O = {
        ...
        updateSlides: function () {
                    ...
                    p[i] && (p[i].swiperSlideSize = L),
                        ...
                        s.centeredSlides
                            ? ((T = T + L / 2 + M / 2 + E),
                              ...
                              h.push(T))
                            : (s.roundLengths && (T = Math.floor(T)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && m.push(T), h.push(T), (T = T + L + E)),
                        (e.virtualSize += L + E),
                        (M = L),
                        (C += 1);
                }
            ...
            if ((Object.assign(e, { slides: p, snapGrid: m, slidesGrid: h, slidesSizesGrid: g }), s.centeredSlides && s.cssMode && !s.centeredSlidesBounds)) {
        ...
        updateSlidesClasses: function () {
            ...
            o &&
                ...
                n
                    ? (p && p.classList.add(s.slideNextClass), d && d.classList.add(s.slidePrevClass))
                    : ((p = (function (e, t) {
                          const s = [];
                ...
                if (y.length > 0 && T) {
                    if (void 0 === t) {
                        ...
                        l
                            ...
                            : (o.slideTo(E + M, 0, !1, !0), a && ((o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t), (o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t)));
                    } else if (a) {
                    ...
                    if (void 0 === t) {
                        ...
                        l
                            ? o.setTranslate(o.translate - t)
                            : (o.slideTo(E - C, 0, !1, !0), a && ((o.touchEventsData.startTranslate = o.touchEventsData.startTranslate - t), (o.touchEventsData.currentTranslate = o.touchEventsData.currentTranslate - t)));
                    } else {
    ...
    function R(e) {
        ...
        if (!s.allowTouchMove) return c.target.matches(a.focusableElements) || (s.allowClick = !1), void (a.isTouched && (Object.assign(n, { startX: u, startY: m, currentX: u, currentY: m }), (a.touchStartTime = o())));
        ...
        if (void 0 === a.isScrolling) {
            ...
            (s.isHorizontal() && n.currentY === n.startY) || (s.isVertical() && n.currentX === n.startX)
                ? (a.isScrolling = !1)
                : h * h + f * f >= 25 && ((e = (180 * Math.atan2(Math.abs(f), Math.abs(h))) / Math.PI), (a.isScrolling = s.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle));
        }
        ...
        if (
            ...
            g > 0
                ? (b &&
                  ...
                  a.currentTranslate > s.minTranslate() && ((x = !1), r.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** E)))
                : g < 0 &&
                  (b &&
                      y &&
                      a.allowThresholdMove &&
                  ...
                  a.currentTranslate < s.maxTranslate() && ((x = !1), r.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - g) ** E))),
        ...
        return function (s) {
            ...
            "object" == typeof a && null !== a
                ? (!0 === e[i] && (e[i] = { enabled: !0 }),
                  ...
                  i in e && "enabled" in a ? ("object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), c(t, s)) : c(t, s))
                : c(t, s);
        };
    }
    const Q = {
            ...
            transition: {
                ...
                transitionStart: function (e, t) {
                    ...
                    const s = this,
                        { params: i } = s;
                    i.cssMode || (i.autoHeight && s.updateAutoHeight(), _({ swiper: s, runCallbacks: e, direction: t, step: "Start" }));
                },
                transitionEnd: function (e, t) {
                    void 0 === e && (e = !0);
                    const s = this,
                        { params: i } = s;
                    (s.animating = !1), i.cssMode || (s.setTransition(0), _({ swiper: s, runCallbacks: e, direction: t, step: "End" }));
                },
            },
            slide: G,
            loop: B,
    ...
    const ue = [
        function (e) {
            ...
            function d(e, t) {
                ...
                let a;
                return (
                    i.renderSlide ? ((a = i.renderSlide.call(s, e, t)), "string" == typeof a && ((o.innerHTML = a), (a = o.children[0]))) : (a = s.isElement ? v("swiper-slide") : v("div", s.params.slideClass)),
                    ...
                    if (
                        ...
                        a.forEach((e) => {
                            ...
                            a === i ? e.classList.add(...s.bulletActiveClass.split(" ")) : t.isElement && e.setAttribute("part", "bullet"),
                                s.dynamicBullets && (a >= o && a <= d && e.classList.add(...`${s.bulletActiveClass}-main`.split(" ")), a === o && p(e, "prev"), a === d && p(e, "next"));
                        });
                    else {
                        const e = a[i];
                        if (
        ...
        function (e) {
            ...
            function g() {
                ...
                let l = p,
                    o = (c - p) * n;
                s ? ((o = -o), o > 0 ? ((l = p - o), (o = 0)) : -o + p > c && (l = c + o)) : o < 0 ? ((l = p + o), (o = 0)) : o + p > c && (l = c - o),
            ...
            function C() {
                ...
                t.params.uniqueNavElements && "string" == typeof i.el && a.length > 1 && 1 === s.querySelectorAll(i.el).length && (a = s.querySelector(i.el)),
                    ...
                    a && ((r = a.querySelector(se(t.params.scrollbar.dragClass))), r || ((r = v("div", t.params.scrollbar.dragClass)), a.append(r))),
        ...
        function (e) {
            ...
            Object.defineProperty(t.zoom, "scale", {
                ...
                Object.assign(t.zoom, { enable: A, disable: I, in: P, out: L, toggle: z });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: i } = e;
            function a(e, t) {
        ...
        function (e) {
            ...
            function h(e) {
                ...
                const s = t.params.a11y,
                    i = e.target;
                (t.pagination && t.pagination.el && (i === t.pagination.el || t.pagination.el.contains(e.target)) && !e.target.matches(se(t.params.pagination.bulletClass))) ||
                        ...
                        (function () {
                            ...
                            f() &&
                                t.pagination.bullets.forEach((s) => {
                                    t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(s) + 1)))),
        ...
        function (e) {
            let { swiper: t } = e;
            Object.assign(t, { appendSlide: ie.bind(t), prependSlide: ae.bind(t), addSlide: re.bind(t), removeSlide: ne.bind(t), removeAllSlides: le.bind(t) });
        },
        function (e) {
            let { swiper: t, extendParams: s, on: i } = e;
            ...
            oe({
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        m <= 1 && m > -1 && ((h = 90 * r + 90 * m), l && (h = 90 * -r - 90 * m), t.browser && t.browser.isSafari && (Math.abs(h) / 90) % 2 == 1 && (h += 0.001)), (s.style.transform = w), p.slideShadows && a(s, m, c);
                    }
                ...
                setTranslate: () => {
                    ...
                    for (let r = 0; r < e.length; r += 1) {
                        ...
                        t.isHorizontal() ? s && (d = -d) : ((u = c), (c = 0), (p = -d), (d = 0)),
                            t.browser && t.browser.isSafari && ((Math.abs(d) / 90) % 2 == 1 && (d += 0.001), (Math.abs(p) / 90) % 2 == 1 && (p += 0.001)),
                    ...
                    for (let s = 0; s < e.length; s += 1) {
                        ...
                        d < 0 ? ((f = r.next), (h = !0)) : d > 0 && ((f = r.prev), (h = !0)),
                            ...
                            m.forEach((e, s) => {
                                ...
                                t.browser && t.browser.isSafari && (Math.abs(i) / 90) % 2 == 1 && (i += 0.001), (m[s] = i);
                            }),
                    ...
                    setTranslate: () => {
                        ...
                        for (let o = 0; o < e.length; o += 1) {
                            ...
                            if (a.slideShadows) {
                                ...
                                e || (e = ce("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(c) - 0.5) / 0.5, 0), 1));
                            }
    ...
    function be(e, t, s) {
        ...
        return (
            "string" == typeof t && void 0 !== s && l.push({ name: t, value: he(s) ? { ...s } : s }),
            l.forEach((e) => {
                const t = we.filter((t) => 0 === e.name.indexOf(`${t}-`))[0];
                if (t) {
                    const s = ge(t),
                        i = ge(e.name.split(`${t}-`)[1]);
                    void 0 === a[s] && (a[s] = {}), !0 === a[s] && (a[s] = { enabled: !0 }), (a[s][i] = ve(e.value));
                } else {
                    const t = ge(e.name);
            ...
            fe(i, a),
            i.navigation ? (i.navigation = { prevEl: ".swiper-button-prev", nextEl: ".swiper-button-next", ...(!0 !== i.navigation ? i.navigation : {}) }) : !1 === i.navigation && delete i.navigation,
            i.scrollbar ? (i.scrollbar = { el: ".swiper-scrollbar", ...(!0 !== i.scrollbar ? i.scrollbar : {}) }) : !1 === i.scrollbar && delete i.scrollbar,
            i.pagination ? (i.pagination = { el: ".swiper-pagination", ...(!0 !== i.pagination ? i.pagination : {}) }) : !1 === i.pagination && delete i.pagination,
                    ...
                    (function (e) {
                        ...
                        const T = (e) => {
                            t[e] &&
                                (t[e].destroy(),
                                "navigation" === e
                                    ? (t.isElement && (t[e].prevEl.remove(), t[e].nextEl.remove()), (p[e].prevEl = void 0), (p[e].nextEl = void 0), (t[e].prevEl = void 0), (t[e].nextEl = void 0))
                        ...
                        a.includes("loop") && t.isElement && (p.loop && !i.loop ? (x = !0) : !p.loop && i.loop ? (E = !0) : (S = !0)),
                            ...
                            a.includes("children") && s && h && p.virtual.enabled ? ((h.slides = s), h.update(!0)) : a.includes("virtual") && h && p.virtual.enabled && (s && (h.slides = s), h.update(!0)),
                            a.includes("children") && s && p.loop && (S = !0),
                            g && f.init() && f.update(!0);
                        v && (t.controller.control = p.controller.control),
                            w &&
                                (!t.isElement || (o && "string" != typeof o) || ((o = document.createElement("div")), o.classList.add("swiper-pagination"), o.part.add("pagination"), t.el.appendChild(o)),
                                o && (p.pagination.el = o),
                                c.init(),
                                c.render(),
                                c.update()),
                            b &&
                                (!t.isElement || (l && "string" != typeof l) || ((l = document.createElement("div")), l.classList.add("swiper-scrollbar"), l.part.add("scrollbar"), t.el.appendChild(l)),
                                l && (p.scrollbar.el = l),
                                m.init(),
                                m.updateSize(),
                                m.setTranslate()),
                            y &&
                                (t.isElement &&
                                    ((r && "string" != typeof r) ||
                                        ((r = document.createElement("div")), r.classList.add("swiper-button-next"), (r.innerHTML = t.hostEl.constructor.nextButtonSvg), r.part.add("button-next"), t.el.appendChild(r)),
                                    (n && "string" != typeof n) ||
                                        ((n = document.createElement("div")), n.classList.add("swiper-button-prev"), (n.innerHTML = t.hostEl.constructor.prevButtonSvg), n.part.add("button-prev"), t.el.appendChild(n))),
