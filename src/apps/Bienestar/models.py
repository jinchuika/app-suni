...
class Colaborador(models.Model):
     ...
     pregunta2 = models.CharField(verbose_name="Si tu respuesta anterior fue afirmativa por favor explica brevemente la enfermedad o condición que te coloca en riesgo.",max_length=2500, null=True, blank=True)
     ...
     pregunta6 = models.CharField(verbose_name="Si tu respuesta anterior fue afirmativa por favor explica a continuación:",max_length=2500, null=True, blank=True)
     ...
     pregunta8 = models.CharField(verbose_name="Explica brevemente tu situación mental o emocional en base a tu respuesta a la pregunta anterior.",max_length=2500, null=True, blank=True)
     ...
     pregunta11 = models.CharField(verbose_name="Si tu respuesta anterior fue afirmativa por favor explica a continuación:",max_length=2500, null=True, blank=True)
     ...
     pregunta13 = models.CharField(verbose_name="Si tu respuesta es afirmativa, ¿qué medidas tomaste?",max_length=2500, null=True, blank=True)
     ...
     pregunta17 = models.CharField(verbose_name="¿Qué medidas de seguridad se están tomando dentro de las instalaciones de la fundación?",max_length=2500, null=True, blank=True)
