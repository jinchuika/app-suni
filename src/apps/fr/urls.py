...
url(r'^contactos/etiqueta/(?P<pk>\d+)/$', views.ContactoEtiqueta.as_view(), name='contacto_etiqueta'),
url(r'^contactos/evento/(?P<pk>\d+)/$', views.ContactoEvento.as_view(), name='contacto_evento'),
