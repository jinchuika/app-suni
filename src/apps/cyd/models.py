...
class Curso(models.Model):
    ...
    fecha_creacion_curso=models.DateField(default=timezone.now)
    informe_curso=models.BooleanField(default=False,blank=False)
    fecha_desactivacion_curso=models.DateField(null=True,blank=True,)
