...
admin_children = (
    ...
    ViewMenuItem(
        "Informe de Entradas",
        reverse_lazy('contabilidad_entrada_beqt'),
        weight=12,
        icon="fa-file-pdf-o",
    ),
    ViewMenuItem(
        "Dispositivos x Entrada",
        reverse_lazy('contabilidad_beqt_entrada_dispositivo'),
        weight=12,
        icon="fa-sign-in",
    ),
    ViewMenuItem(
        "Informe de Salidas",
        reverse_lazy('contabilidad_beqt_salidas'),
        weight=12,
        icon="fa-file-pdf-o",
    ),   
    ViewMenuItem(
        "Resumen",
        reverse_lazy('contabilidad_beqt_resumen'),
        weight=12,
        icon="fa-file-pdf-o",
    ),
)
