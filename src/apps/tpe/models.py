...
class VisitaMonitoreo(models.Model):
    ...
    comentario = models.TextField(null= True, blank = True)
    contacto = models.ForeignKey(escuela_m.EscContacto,related_name='visitas_contactos')
    fotos_link = models.URLField(null = True, blank = True , verbose_name='Imagen')
    ...
    ticket = models.ForeignKey(TicketSoporte, related_name='visitas_soporte');
